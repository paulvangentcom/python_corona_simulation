...
class Simulation():
    ...
    def tstep(self):
        ...
        #find new infections
        self.population, self.destinations = Infection.Infection_locator.infect(self.population, self.Config, self.frame, 
        ...
        #recover and die
        self.population = Infection.Infection_computator.recover_or_die(self.population, self.frame, self.Config)
