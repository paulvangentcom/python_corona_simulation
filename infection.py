...
class Infection:
    '''The Root Aggregate class for infection.py'''
    
    class Infection_locator():
        '''class contains all methods to locate infectors and entity in proximity of infectors'''
    ...
    class Infection_computator():
        '''class contains all computation for infection'''
        ...
        def healthcare_infection_correction(worker_population, healthcare_risk_factor=0.2):
            ...
            by reducing (if < 0) or increasing (if > 0) sick healthcare workers
